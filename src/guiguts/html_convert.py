            ...
            if selection and not selection_lower.startswith(
                ...
                auto_toc += "\n".join(
                    [
                        ...
                        f'    <a class="toc-title" href="#{sec_chap_id}">{chap_heading}</a>',
                        '    <!--<span class="toc-page">NN</span>-->',
                        "  </li>",
                        "",
                    ]
                )
        ...
        maintext().insert(
            ...
            "\n".join(
                [
                    ...
                    '<ul class="toc-list">',
                    "  <!-- Header row -->",
                    '  <!--<li class="toc-entry toc-head">',
                    '    <span class="toc-num">Chap.</span>',
                    '    <span class="toc-title">Title</span>',
                    '    <span class="toc-page">Page</span>',
                    "  </li>-->",
                    f"{auto_toc}</ul>",  # auto_toc has trailing newline already
                    "</div>",
                    "</nav>",
